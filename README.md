...
The original NanoStat implementation uses ESP32-PICO hardware and provides a fully wireless potentiostat system with a web-based user interface. In this work, the firmware and hardware were modified to operate on ESP32 DevKit V1.
